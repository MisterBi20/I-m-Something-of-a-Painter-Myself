...
def Generator():
    ...
    initializer = tf.random_normal_initializer(0., 0.02)
    last = layers.Conv2DTranspose(Config.CHANNELS, 4,
                                  strides=2,
                                  padding='same',
...
def Discriminator():
    ...
    inp = layers.Input(shape=[Config.IMAGE_SIZE, Config.IMAGE_SIZE, Config.CHANNELS], name='input_image')
